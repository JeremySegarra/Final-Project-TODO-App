...
export const MessagesStore = defineStore("messages", {
  state: (): { my: Array<any>; sentMessages: Array<any> } => ({
    my: [],
    sentMessages: [],
  }),
  actions: {
    ...
    deleteMessage(index: number) {
      ...
      // console.log(
      //   "I am in Delete Why am i not deleteing! ",
      //   index,
      //   "      ",
      //   currentUser
      // );
      // console.log("I am printing sendToUser");
      // console.table(sendToUser);

      // console.log("I am printing usersList");
      // console.table(users.list);
